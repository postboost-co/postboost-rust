...
pub struct ImageGenerate200Response {
    #[serde(rename = "data")]
    pub data: Box<models::ImageGenerationResponse>,
}

impl ImageGenerate200Response {
    pub fn new(data: models::ImageGenerationResponse) -> ImageGenerate200Response {
