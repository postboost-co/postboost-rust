...
pub struct ImagePrompt200Response {
    #[serde(rename = "data")]
    pub data: Box<models::ImagePromptResponse>,
}

impl ImagePrompt200Response {
    pub fn new(data: models::ImagePromptResponse) -> ImagePrompt200Response {
