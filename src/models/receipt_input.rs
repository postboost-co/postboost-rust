...
impl ReceiptInput {
    pub fn new(workspace_uuid: uuid::Uuid, transaction_id: String, invoice_number: String, amount: f64, tax: f64, currency: String, paid_at: String) -> ReceiptInput {
        ReceiptInput {
            workspace_uuid,
            transaction_id,
            invoice_number,
