...
pub struct ImageVariations200Response {
    #[serde(rename = "data")]
    pub data: Box<models::ImageVariationsResponse>,
}

impl ImageVariations200Response {
    pub fn new(data: models::ImageVariationsResponse) -> ImageVariations200Response {
