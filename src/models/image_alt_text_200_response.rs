...
pub struct ImageAltText200Response {
    #[serde(rename = "data")]
    pub data: Box<models::ImageAltTextResponse>,
}

impl ImageAltText200Response {
    pub fn new(data: models::ImageAltTextResponse) -> ImageAltText200Response {
